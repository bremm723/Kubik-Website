...
// Scroll ke bawah ketika panah diklik
...
// Fungsi Salin Link (untuk tombol 🔗)
function copyLink() {
...
// Tambahin ke elemen
document.querySelectorAll(".fade-in, .slide-left, .slide-right, .zoom-in, .photo-scroll img, footer").forEach(el => {
  observer.observe(el);
});
